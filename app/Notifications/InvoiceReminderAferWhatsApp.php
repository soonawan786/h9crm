...
class InvoiceReminderAferWhatsApp extends BaseNotification
{
    ...
    public function toWhatsApp($notifiable)
    {
        ...
        $content = $clientName. PHP_EOL. PHP_EOL .__('email.invoiceReminder.line1').'*Rs.'.$this->invoice->total.'*'.__('email.invoiceReminder.line2').$url .__('email.invoiceReminder.line3').PHP_EOL.PHP_EOL.__('email.invoiceReminder.line4').$this->company->company_phone.'.'.__('email.invoiceReminder.line5').PHP_EOL.PHP_EOL.__('email.invoiceReminder.line6').PHP_EOL.PHP_EOL.'Best regards, '.PHP_EOL.PHP_EOL.$this->company->company_name.PHP_EOL.PHP_EOL.$this->company->company_phone;
