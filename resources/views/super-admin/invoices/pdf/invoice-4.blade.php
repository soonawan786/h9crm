        ...
        <div class="right-invoice">
            <section id="memo">
                <div class="client-logo">
                    <div>
                        <img style="height:100px;" src="{{ $globalInvoiceSetting->logo_url }}" />
                    </div>
                    <div class="company-info description">
                            <br>
                        <div class="description">
                            {{ mb_ucwords($superadmin->global_app_name) }}
                        </div>
                        <span class="description">{{ $superadmin->company_phone }}</span>
                            <br>
                        <span class="description">{!! nl2br($superadmin->addres) !!}</span>
                    </div>
                </div>

                <div class="logo">
                        <img src="{{ $company->logo_url }}"
                            alt="{{ mb_ucwords($company->company_name) }}" class="logo"/>
            ...
            <section id="invoice-title-number">
                <div class="title-top description" >
                    ...
                    <span>{{ $invoice->pay_date->translatedFormat($company->date_format) }}</span>
                </div>
            ...
            <section id="client-info">
                    ...
                    <div class="client-name">
                        <strong>{{ mb_ucwords($company->company_name) }}</strong>
                    </div>
                    <div class="mb-3">
                        <span>
            ...
            <section id="items">
                ...
                <table cellpadding="0" cellspacing="0" >
                    ...
                    <tr data-iterate="item">
                        ...
                        <td>
                            {{ ucfirst($invoice->package->name)  }} - @lang('superadmin.'.$invoice->company->package_type)
                        </td>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2" style="font-size:15px" align="right">
                            ...
                            src="{{ $globalInvoiceSetting->authorised_signatory_signature_url }}" alt="{{ mb_ucwords($global->company_name) }}"/><br>
