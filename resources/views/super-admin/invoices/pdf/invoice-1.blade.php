            ...
            <tr>
                    ...
                    <div  class="description">
                        <div class="client-logo-div">
                            <img src="{{ $company->logo_url }}"
                                alt="{{ mb_ucwords($company->company_name) }}" class="client-logo"/>
                        </div>
                ...
                <td>
                    <div id="company"  class="description">
                        ...
                        <div>{{ mb_ucwords($superadmin->global_app_name) }}</div>
                        <div>{{ $superadmin->company_phone }}</div>
                        <div>{!! nl2br($superadmin->addres) !!}</div>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <div id="details">
            <div id="invoice"  class="description">
                ...
                <div class="date">@lang('superadmin.issue_date'):
                    {{ $invoice->pay_date->translatedFormat($global->date_format) }}
                </div>
            </div>
        </div>
        <table cellspacing="0" cellpadding="0" id="invoice-table">
            ...
            <tbody>
                <tr style="page-break-inside: avoid;">
                    <td class="no">1</td>
                    <td class="desc">
                        <h3>{{ ucfirst($invoice->package->name)  }} - @lang('superadmin.'.$invoice->company->package_type) </h3>
                    </td>
                    <td class="desc">
