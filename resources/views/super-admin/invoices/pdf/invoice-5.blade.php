...
<table class="bg-white" border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
    ...
    <!-- Table Row Start -->
    <tr>
        <td><img src="{{ $globalInvoiceSetting->logo_url }}" alt="{{ mb_ucwords($superadmin->global_app_name) }}"
                 id="logo"/></td>
            ...
            <table class="text-black mt-1 f-13 b-collapse rightaligned">
                ...
                <tr>
                    ...
                    <td class="heading-table-right">
                        {{ $invoice->pay_date->translatedFormat($invoice->company->date_format) }}
                    </td>
                </tr>
    ...
    <tr>
        <td class="f-14 text-black">
            <p class="line-height mb-0 ">
                ...
                {{ mb_ucwords($superadmin->global_app_name) }}<br>
                {{ $superadmin->company_phone }}<br>
                {!! nl2br($superadmin->addres) !!}<br>
            </p>
        </td>
        <td class="f-14 text-black" align="right">
            <p class="line-height mb-0">
                        <span class="text-grey text-capitalize">
                            ...
                            @lang('app.address') : {!! nl2br($company->address) !!}
        ...
        @if ($globalInvoiceSetting->authorised_signatory && $globalInvoiceSetting->authorised_signatory_signature)
            <td class="" align="right">
                <img style="height:95px; margin-bottom: -50px; margin-top: 5px;"
                     ...
                     alt="{{ mb_ucwords($global->company_name) }}"
                     id="logo"/><br>
