        ...
        <div class="text-center mb-70">
            <div class="btn-group" data-toggle="buttons">
                ...
                <label class="btn btn-round btn-outline btn-dark w-150">
                    <input type="radio" onchange="planShow('yearly')" name="pricing" value="yearly" autocomplete="off"> @lang('app.annually')
                </label>
            </div>
        </div>
                            ...
                            <div class="pricing pricing-3">
                                @if($item->recommended)
                                    <div class="pricing__head bg--primary boxed background-color"> <span class="label">@lang('app.recommended')</span>
                                        ...
                                        <p class="type--fine-print">@lang('superadmin.frontCms.perMonth'), {{ $global->currency->currency_code }}.</p>
                                    </div>
                                @else
                            ...
                            <div class="pricing pricing-3">
                                @if($item->recommended)
                                    <div class="pricing__head bg--primary boxed background-color"> <span class="label">@lang('app.recommended')</span>
                                        ...
                                        <p class="type--fine-print">@lang('superadmin.frontCms.perYear'), {{ $global->currency->currency_code }}.</p>
                                    </div>
                                @else
                                    <div class="pricing__head bg--secondary boxed planNameHead">
