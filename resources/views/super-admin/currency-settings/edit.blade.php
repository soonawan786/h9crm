...
<div class="modal-body">
    <x-form id="editCurrency">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 regular-currency"
                ...
                <x-forms.number class="mr-0 mr-lg-2 mr-md-2"
                                ...
                                :fieldValue="$currency->exchange_rate" fieldRequired="true" fieldHelp="( {{companyOrGlobalSetting()->currency->currency_code}} {{__('app.to')}} {{$currency->currency_code}} )">
                </x-forms.number>
