<div class="modal-header">
    <h5 class="modal-title">@lang('app.edit') @lang('superadmin.menu.faq') ( {{$langCode->language_name}} <span class='flag-icon flag-icon-{{ $langCode->language_code == 'en' ? 'gb' : strtolower($langCode->language_code) }} flag-icon-squared'></span> )</h5>
