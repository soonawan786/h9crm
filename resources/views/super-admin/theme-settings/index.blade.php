                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2 cropper"
                                      ...
                                      :fieldValue="global_setting()->logo_front_url" fieldName="logo_front" fieldId="logo_front"
                    ...
                    <div class="col-lg-4">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2 cropper"
                                      :fieldLabel="__('modules.accountSettings.darkCompanyLogo')" :fieldValue="global_setting()->defaultLogo()"
