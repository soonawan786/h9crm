...
<div id="container">
    ...
    <section id="terms">
        <div class="notes">
            <div>
                <span>@lang('modules.estimates.validTill'):</span> <span>{{ $estimate->valid_till ? $estimate->valid_till->translatedFormat($company->date_format) : '--' }}</span>
            </div>
            @if($estimate->status == 'unpaid')
            <div>
                <span>@lang('app.dueDate'):</span> <span>{{ $estimate->due_date->translatedFormat($company->date_format) }}</span>
            </div>
            @endif
            <div>
